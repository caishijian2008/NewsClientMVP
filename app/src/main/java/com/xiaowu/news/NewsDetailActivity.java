...
import com.xiaowu.news.custom.CustomTextView2;
...
public class NewsDetailActivity extends Activity {
	...
	private CustomTextView2 mNewsBodyDetail;	//新闻详细内容
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		inflateView(0); ///XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
		//启动线程
	...
	private void inflateView(int index) {
		...
		View mNewsBodyView = mNewsbodyLayoutInflater.inflate(R.layout.newsbody_layout, null);
		...
		mNewsBodyDetail = (CustomTextView2) mNewsBodyView.findViewById(R.id.news_body_details);
		mNewsBodyDetail.setText(getNewsBody()); ///XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
